...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://zystudent-manage.oss-cn-beijing.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-beijing.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAI9ve5by2hPP1T";
        String accessKeySecret = "pX35KZWkn515eTaOP1N0zuL2dWM498";
        //Bucket名称
        String bucketName = "zystudent-manage";
        //目录名称
        String filedir = "img";
        //获得本地文件的文件名
    ...
    public static void main(String[] args) {
        File file = new File("G:\\image\\bg.jpg");
