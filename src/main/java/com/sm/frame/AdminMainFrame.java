...
public class AdminMainFrame extends JFrame{
    ...
    public AdminMainFrame(Admin admin)  {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                新增学生Button.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        cClass.setClassName(CClassField.getText());
        ...
        private void showStudentTable(List<StudentVO> studentList) {
                ...
                //表头内容
                model.setColumnIdentifiers(new String[]{"学号","院系","班级","姓名","性别","地址"
                        ,"手机号","出生日期","头像"});
                //遍历List,转成Obiect数组
                for (StudentVO student:studentList){
                    Object[] object = new Object[]{student.getId(),student.getDepartmentName(),
                            student.getClassName(),student.getStudentName(),student.getGender(),student.getAddress(),
        ...
        删除院系Button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {

            }
        });
        deNameField.addFocusListener(new FocusAdapter() {
            @Override
